            ...
            <?php
                ...
                if ($result->num_rows > 0) {
                    while($row = $result->fetch_assoc()) {
                        ...
                        $cmd = "<tr><form action='show_salary.php' method='post'><input type='text' style='display:none;' name='ID' value=".$row['uname']."><tr><td>"."EMP".substr($row['doj'],2,2).$row['empid']."</td><td><img class='user-icon' src='photos/".$row['photo']."'</td><td>".
